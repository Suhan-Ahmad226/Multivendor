    ...
    return (
        <footer className='bg-[#f3f6fa]'>
                ...
                <div className='w-3/12 lg:w-4/12 sm:w-full'>
                    <div className='flex flex-col gap-3'>
                        ...
                        <ul className='flex flex-col gap-2 text-slate-600'>
                            <li>Address :  New Market, Dhaka-1205,</li>
                            <li>Phone : +8801518947696, +8801401424534</li>
                            <li>Email : nittyonjoni@gmail.com</li>
                        </ul> 
                    </div> 
                </div>
            ...
            <div className='w-[90%] flex flex-wrap justify-center items-center text-slate-600 mx-auto py-5 text-center'>
                <span>Copyright ©️ Nittyonjoni All Rights Reserved </span>
            </div>
