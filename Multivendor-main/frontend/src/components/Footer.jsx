        ...
        <div className="md:col-span-2 lg:col-span-2 grid grid-cols-2 gap-8 sm:gap-4">
          <div>
            ...
            <ul className="space-y-2 text-sm font-medium">
              <li><Link to="/about" className="hover:text-[#059473] transition">About Us</Link></li>
              <li><Link to="/about" className="hover:text-[#059473] transition">About Our Shop</Link></li>
              <li><Link to="/delivery-info" className="hover:text-[#059473] transition">Delivery Information</Link></li>
              <li><Link to="/privacy-policy" className="hover:text-[#059473] transition">Privacy Policy</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm font-medium">
              <li><Link to="/services" className="hover:text-[#059473] transition">Our Service</Link></li>
              <li><Link to="/company-profile" className="hover:text-[#059473] transition">Company Profile</Link></li>
              <li><Link to="/delivery-info" className="hover:text-[#059473] transition">Delivery Information</Link></li>
              <li><Link to="/privacy-policy" className="hover:text-[#059473] transition">Privacy Policy</Link></li>
              <li><Link to="/blog" className="hover:text-[#059473] transition">Blogs</Link></li>
            </ul>
          ...
          <ul className="flex gap-3 mt-5">
            <li>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-10 h-10 bg-white rounded-full flex items-center justify-center hover:bg-[#059473] hover:text-white transition shadow"
