                            ...
                            <AnimatePresence mode="wait">
                                ...
                                {paymentMethod === 'cod' && (
                                    <motion.div
                                        ...
                                        exit="exit"
                                        transition={{ duration: 0.4 }}
                                        className="bg-white p-6 rounded-xl shadow-lg flex flex-col items-center justify-center gap-3"
                                    >
                                        <p className="text-sm text-gray-600 text-center max-w-md">
                                            You have chosen <span className="font-semibold">Cash on Delivery</span>. You&apos;ll pay to the
                                            delivery agent when the order arrives.
                                        </p>
                                        <button
                                            onClick={() => {
                                            ...
                                            className="px-14 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 shadow-lg hover:shadow-green-500/40 transition-all duration-300 text-lg font-medium"
                                        >
                                            Confirm Order
                                        </button>
                                    </motion.div>
