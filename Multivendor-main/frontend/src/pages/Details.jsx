        ...
        <div className="grid grid-cols-2 gap-10 md:grid-cols-1">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
              ...
              <div className="flex items-center gap-3">
                <a
                  className="w-10 h-10 rounded-full bg-indigo-500 text-white flex items-center justify-center hover:bg-[#059473] transition"
                ...
                <a
                  className="w-10 h-10 rounded-full bg-cyan-500 text-white flex items-center justify-center hover:bg-[#059473] transition"
                ...
                <a
                  className="w-10 h-10 rounded-full bg-purple-600 text-white flex items-center justify-center hover:bg-[#059473] transition"
                ...
                <a
                  className="w-10 h-10 rounded-full bg-slate-700 text-white flex items-center justify-center hover:bg-[#059473] transition"
                  href="https://github.com"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="share-github"
                >
                  <FaGithub />
                </a>
              </div>
